...
export default function ScrapMetalScreen({navigation}){
    ...
    const getTonnage = () => {
        fetch(`${CENTRAL_API}agent/concessionaires-product-codes?category=ScrapMetal`, {
            headers: {
                'accept': 'application/json',
                'Content-Type': 'application/json'
            },
    ...
    const processTicket = () =>{
        if(tonnage === null || content === '' || plateNumber === '' || name === '' || phone === '' || collectionPoint === '') {
