...
export default function InterStateHaulageScreen({navigation}){
            ...
            <PaperProvider>
                ...
                <View style={{marginTop: 5}}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                        ...
                        <Picker.Item label="Containerized 40Ft" value="Containerized40Ft" />
                        <Picker.Item label="Truck/Trailer" value="TruckTrailer" />
                        <Picker.Item label="911 Truck" value="911Truck" />
                        <Picker.Item label="Bus & Other" value="BusOther" />
                        <Picker.Item label="Double Axle" value="DoubleAxle" />
                        <Picker.Item label="Tipper" value="Tipper" />
                        <Picker.Item label="Containerized 20Ft" value="Containerized20Ft" />
