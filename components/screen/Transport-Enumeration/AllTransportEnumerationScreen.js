                                ...
                                <View style={{marginBottom: 10}}>
                                    <View style={{
                                        ...
                                        <View>
                                            ...
                                            <Text
                                                style={styles.amount}>&#8358;{Intl.NumberFormat("en-US", options).format(walletBalance.wallet_balance) || 0}</Text>
                                            <Text style={styles.collected}> </Text>
                                        </View>
                                        <View>
                                            <Text style={styles.walletTitle}>Current Earnings</Text>
                                            <Text
                                                style={styles.amount}>&#8358;{Intl.NumberFormat("en-US", options).format(walletBalance.current_earnings)}</Text>
                                            <Text style={styles.collected}>Total
                                                Collected: &#8358;{Intl.NumberFormat("en-US", options).format(total.total_amount)}</Text>
                                        </View>
                                    </View>
                                </View>
                            </Card.Content>
                                ...
                                <View style={{marginBottom: 10}}>
                                    <View style={{
                                        ...
                                        <View>
                                            ...
                                            <Text
                                                style={styles.amount}>&#8358;{Intl.NumberFormat("en-US", options).format(fidelityBalance.balance) || 0}</Text>
                                            <Text style={styles.collected}> </Text>
                                        </View>
                                        <View>
                                            <Text style={styles.walletTitle}>Current Earnings</Text>
                                            <Text
                                                style={styles.amount}>&#8358;{Intl.NumberFormat("en-US", options).format(fidelityBalance.earnings)}</Text>
                                            <Text style={styles.collected}>Total
                                                Collected: &#8358;{Intl.NumberFormat("en-US", options).format(total.total_amount)}</Text>
                                        </View>
                                    </View>
