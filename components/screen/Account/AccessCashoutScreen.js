...
export default function AccessCashoutScreen({navigation, route}) {
    ...
    const getAccountDetails = async () => {
        ...
        await fetch(url, {
            ...
            .then((responseJson) => {
                ...
                setAccountDetails(responseJson.access)
    ...
    const processCashOut = async () => {
        showModal()
        setLoading(true)
        await fetch(`${MOBILE_API}wallet/access-transfer-funds`, {
            headers: {
                "accept": "application/json",
                "authorization": "Bearer" + userToken,
                "Content-Type": "application/json"
    ...
    const walletPayment = async () => {
        showModal()
        setLoading(true)
        await fetch(`${MOBILE_API}wallet/access-release-funds`, {
            headers: {
                "accept": "application/json",
                "authorization": "Bearer" + userToken,
                "Content-Type": "application/json"
                    ...
                    cashOutType === 'bank' ? (
                        ...
                        <View>
                            <View style={{marginTop: 5, flexDirection: 'row'}}>
                                ...
                                <Text style={styles.label}>{accountDetails.wallet_id}</Text>
                            </View>
                            <Divider style={{
                                marginLeft: 16,
                                marginRight: 16,
                            ...
                            <View style={{marginTop: 5, flexDirection: 'row'}}>
                                ...
                                <Text style={styles.label}>{accountDetails.wallet_name}</Text>
                            </View>
                            <Divider style={{
                                marginLeft: 16,
                                marginRight: 16,
