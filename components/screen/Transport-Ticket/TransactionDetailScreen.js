...
import {Alert, Dimensions, ScrollView, Share, StyleSheet, Text, View} from "react-native";
            ...
            <View style={{marginTop: 5}}>
                ...
                <Card style={styles.card}>
                    <View style={{
                        ...
                        <Text style={styles.status}>{transactionDetails.status}</Text>
                    </View>
                    <Divider />
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 15}}>
                        <Text style={styles.rowLabel}>Transaction Date:</Text>
                        <Text style={styles.rowData}>{Moment(transactionDetails.trans_date).format('DD MMM yyyy')}</Text>
                    </View>
                    <Divider />
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 15}}>
                    ...
                    <View style={{
                        ...
                        <Text style={styles.rowData}>{transactionDetails.createtime}</Text>
                    </View>
                    <Divider />
                    <View style={{
                        flexDirection: 'row',
